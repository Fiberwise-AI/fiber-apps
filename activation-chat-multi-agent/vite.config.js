...
let appId = 'activation-chat-multi-agent'; // Default or placeholder
...
export default defineConfig({
  ...
  build: {
    ...
    rollupOptions: {
      ...
      // Define external dependencies if any (e.g., shared SDKs)
      // external: [], // Don't mark any imports as external
    },
    // commonjsOptions: {
